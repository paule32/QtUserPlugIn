...
{
    QMessageBox::information(0,"Test","clicker 1");
}

void Rechner::btn2Clicked()
{
    QMessageBox::information(window(),"Test","clicker 2");
}

void Rechner::btn3Clicked()
{
    QMessageBox::information(window(),"Test","clicker 3");
}
